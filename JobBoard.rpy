...
translate arabic strings:
    ...
    new "{color=#f7f6ef}أي مساعد يريد أن يثبت نفسه للعائلة، عليه بأن يفعل أياً كان في أي وقت كان. يتطلب هذا أحياناً خفة اليد\nأول عقد يستطيع المساعد العمل به هو عقد يطلب منه سرقة أشياء قيمة من المحلات أو المواطنين في أراضي العوائل المعادية\nتستطيغ السرقة من أي هدف\nإنتبه، حاول تجنب الأهداف الصعبة والشخصيات المهمة، حتى وإن نجحت، ستبقى مكافأتك بنفس القيمة المذكورة في العقد\n\n-ويلفريد {/color}"
    ...
    new "{color=#f7f6ef}ناك شائعة بأن بعض أفراد عائلة بونازو يتطفلون في أنحاء لوكانيا في الليل. تأكد من هذه الإشاعة، تتبعه وابقى في الظلال، أو حتى صادقهم، افعل ما تراه مناسباً\nإنتبه، علاقتنا مع عائلة بونانوز ودية. العنف ممنوع.\n\n -ويلفريد {/color}"
   
    # game/JobBoard.rpy:336
    old "Time rqmts = {color=#f7f6ef}Night{/color}"
    new "{color=#f7f6ef}الليل{/color} وقت المهمة: "

    # game/JobBoard.rpy:343
    old "Money = {color=#f7f6ef}$60-$75{/color}"
    new " {color=#f7f6ef}$60-$75{/color} المال: "

    # game/JobBoard.rpy:344
    old "Exp = {color=#f7f6ef}25-35{/color}"
    new "{color=#f7f6ef}25-35{/color} نقاط الخبرة: "
    ...
    new " {color=#f7f6ef}$100-$150{/color} المال: "

    # game/JobBoard.rpy:397
    old "Exp = {color=#f7f6ef}40-60{/color}"
    new "{color=#f7f6ef}40-60{/color} نقاط الخبرة: "
    ...
    new "{color=#f7f6ef}وصلنا خبر ان سكان مدينتنا، لوكانيا، يتعرضون للمضايقات من قبل حفنة من الغرباء. ولأي شخص يقبل بهذا العقد، مهمتك واضحة. اعثر عليهم وقل لهم ان يتوقفوا عن ذلك بكل ادب. وإذ لم يجدي ذلك، فاجبرهم بطريقة او بأخرى. \n\n- ويلفريد {/color}"

    # game/JobBoard.rpy:451
    old "Money = {color=#f7f6ef}$30-$35{/color}"
    new " {color=#f7f6ef}$30-$35{/color} المال: "

    # game/JobBoard.rpy:452
    old "Exp = {color=#f7f6ef}15-25{/color}"
    new "{color=#f7f6ef}15-25{/color} نقاط الخبرة: "
    ...
    new "{color=#f7f6ef}فرد ذوشأن عالي من عائلة تراديمانو سيأتي لزيارة مدينتنا. مهمتك هي ان ترافقه وتضمن سلامته. \n\n- ويلفريد {/color}"
    # game/JobBoard.rpy:502
    old "Money = {color=#f7f6ef}$130-$160{/color}"
    new " {color=#f7f6ef}$130-$160{/color} المال: "

    # game/JobBoard.rpy:503
    old "Exp = {color=#f7f6ef}60-80{/color}"
    new "{color=#f7f6ef}60-80{/color} نقاط الخبرة: "
    ...
    new "{color=#f7f6ef}هنالك مثيري للشغب في حانة المسنة جينا اذهب هناك وحل المشكلة. العنف مسموح إذ توضح انهم مشاغبون فعلاً ولكن قتلهم غير مسموح بالبتة.\n\n- Wilfred {/color}"

    # game/JobBoard.rpy:556
    old "Money = {color=#f7f6ef}$35-$45{/color}"
    new " {color=#f7f6ef}$30-$45{/color} المال: "

    # game/JobBoard.rpy:557
    old "Exp = {color=#f7f6ef}20-30{/color}"
    new "{color=#f7f6ef}20-30{/color} نقاط الخبرة: "
    ...
    new "{color=#f7f6ef}السيد قيانوتي اشتكى لنا بأن خطيت ابنته الجديد يعاملها بسوء، ذكر خطيبها بالحب واقنعه بأي طريقة كانت (غير قاتلة).\n\n- ويلفريد {/color}"

    # game/JobBoard.rpy:608
    old "Money = {color=#f7f6ef}$160-$200{/color}"
    new " {color=#f7f6ef}$160-$200{/color} المال: "

    # game/JobBoard.rpy:609
    old "Exp = {color=#f7f6ef}100-120{/color}"
    new "{color=#f7f6ef}100-120{/color} نقاط الخبرة: "
    ...
    new "{color=#f7f6ef}أحد رؤساء العائلة الفرعيين بحاجة إلى رجال أكثر. سترافقه مع فريق خاص في مهمة تسلل حساسة، هناك إحتمال كبير للحاجة إلى العنف، تعال متحضراً\n\n- ويلفريد {/color}"
    ...
    new " {color=#f7f6ef}$260-$350{/color} المال: "

    # game/JobBoard.rpy:660
    old "Exp = {color=#f7f6ef}200-250{/color}"
    new "{color=#f7f6ef}200-250{/color} نقاط الخبرة: "
    ...
    new "{color=#f7f6ef}{b}عقد خاص{/b}\n\n[povname]هذه مهمة حساسة، لا تبدأ إلا عندما تتأكد بأنك قادر على النجاح في المهمة، الفشل غير مقبول إطلاقاً.. لا نريد أن نثير غضب منظم الباسيفاكاتوريين. لديك كل المعلومات الضرورية، حظاً موفقاً \n\n- Wilfred {/color}"
