...
translate arabic strings:
    ...
    new "{color=#d8d2b8}{size=+10}القصة ووضع التنقل الحر{/size}{/color}\n\nيوجد قسمين للعبة، وضع القصة ووضع التنقل الحر\nسبب تقسيم اللعبة لقسمين هي لإعطاء اللاعب كامل الحرية بسرعة التقدم بالقصة. وضع التنقل الحر يسمح لك بالإستمتاع باللقطات الجنسية أو الأحداث الغير جادة الموجودة في حياة عائلة ديلوكا . تستطيع الوصول إلى وضع القصة عن طريق زر المتابعة، حيث يمكنك المواصلة في الأحداث الأكثر جدية . هذا لا يعني إنعدام وضع القصة من الأحداث الجنسية أو إنعدام وضع التنقل الحر من الجدية، لكنها مجرد إستثناءات. ضع في عين الإعتبار أن خياراتك في وضع التنقل الحر تؤثر في القصة والعكس صحيح."
    ...
    new "{color=#ff235e}{size=+10}نقاط العلاقات{/size}{/color}\n\nتسمح لك نقاط العلاقة بمعرفة مدى تقدم علاقتك مع الشخصيات المختلفة. سيظهر لك إشعار في يسار الزاوية العليا من الشاشة في حال تأثرت علاقتك مع أحد الشخصيات بطريقة إيجابية أو سلبية، بقلب أحمر للإناث وقلب أزرق للذكور. إذا كانت نقاط علاقتك مع شخصية معينة بالمستوى المطلوب، ستظهر لك خيارات مختلفة ملونة بلون مناسب وواضح\n\nتستطيع معرفة مدى تقدم علاقتك مع أحد الشخصيات عن طريق قائمة معلومات الشخصيات. مع إختلاف العلاقة، يختلف مدى إثارة وضعية الشخصية، وملابسها (إن كانت ما زالت ترتدي الملابس في هذه المرحلة من العلاقة). \n\n{color=#91c2ff}{size=+10}الشخصية{/size}{/color}\n\nبناءً على إختياراتك وردات فعلك لحوادث معينة، تتغير شخصية الشخصية الرئيسية وتتطور، على سبيل المثال; ردة فعل شخصيتك تجاه المجندين بعد الفشل بالعملية سيعتمد بشكل كبير على صفاتك الشخصية، ما إن كنت ستضحك كالمجنون أو تتعامل مع الموقف بهدوء أو تستشيط غضباً، الخ...\n\n{color=#ffe189}{size=+10}الضمير{/size}{/color}\n\nيعد الضمير مؤشراً على مدى تقبل شخصيتك لكسر القواعد وعمل الضروري في عالم المافيا. شخصية بضمير منخفض على سبيل المثال لن يواجه مشكلة بقتل الأعداء أو السرقة أو عمل مهام معينة، كما أن خيارات إعدام العدو لديك ستختلف على حسب ضمير الشخصية الرئيسية"
    ...
    new "{color=#d8d2b8}{size=+10}العقود{/size}{/color}\n\nيتم ترتيب العقود بناءً على الصعوبة من المرحلة E إلى المرحلة SSS. كلما زادت صعوبة العقد كانت الجائزة أعلى. تعتمد العقود المتاحة للاعب على رتبة اللاعب في العصابة. تستطيع عادة أخذ العقد أكثر من مرة ولكن بعض العقود متاحة لمرة واحدة فقط، بالإضافة أن العقود بمستوى SS وفوق لا يستطيع قبولها إلا أحد أعضاء الأفاعي الأربع\n\n{color=#d8d2b8}{size=+10}أغراض المتجر{/size}{/color}\n\nتعتمد الأغراض المعروضة في المتجر على رتبتك في العصابة. احياناً قد تؤثر خياراتك على ما يظهر لك في المتجر أيضاً. الأغراض النادرة غالباً ما يتم إلحصول عليها عن طريق إتمام العقود ذات المستوى العالي أو كجائزة في البطولات."
    # game/HelpScreen.rpy:103
    old "{u}{color=#d8d2b8}{size=+11}Main Story{/size}{/color}{/u}"
    new "{u}{color=#d8d2b8}{size=+11}القصة الرئيسية{/size}{/color}{/u}"

    # game/HelpScreen.rpy:105
    old "Story 1: The Dangerous Dinner"
    new "Story 1: الغداء الخطر"

    # game/HelpScreen.rpy:107
    old "{color=#3fc635}Story 1: The Dangerous Dinner{/color}"
    new "{color=#3fc635}القصة 1: الغداء الخطر{/color}"

    # game/HelpScreen.rpy:110
    old "Story 2: The Hidden Recorders\n{color=#e2b785}{size=-9} -REQ. Buy hidden camera/audio{/color}{/size}"
    new "القصة 2: المسجلات المخفية\n{color=#e2b785}{size=-9}مطلوب: شراء كاميرا أو مسجل صوت{/color}{/size}"

    # game/HelpScreen.rpy:112
    old "{color=#3fc635}Story 2: The Hidden Recorders{/color}"
    new "{color=#3fc635}القصة 2: المسجلات المخفية{/color}"

    # game/HelpScreen.rpy:115
    old "Story 3: The Punishment\n{color=#e2b785}{size=-9} -REQ. Daytime{/color}{/size}"
    new "القصة 3: العقاب\n{color=#e2b785}{size=-9}مطلوب: بدأ المهمة في النهار{/color}{/size}"

    # game/HelpScreen.rpy:117
    old "{color=#3fc635}Story 3: The Punishment{/color}"
    new "{color=#3fc635}القصة 3: العقاب{/color}"
    ...
    new "{color=#3fc635}اللمسة السحرية!{/color}"
    ...
    new "{color=#3fc635}ملابس الرقص{/color}"
    ...
    new "{color=#3fc635}العين بالعين والنبيذ بالنبيذ{/color}"
