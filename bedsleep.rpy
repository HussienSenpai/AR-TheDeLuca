...
translate arabic bedsleep_b7304cce:
    ...
    wf "كنت راقصاً جيداً في أيام شبابي. للأسف، جودة الملابس تدهورت منذ ذلك الوقت"

# game/bedsleep.rpy:40
translate arabic bedsleep_31423554:

    # pov "Okay, you looked inside my package!"
    pov "لقد نظرت داخل الطرد!"
...
translate arabic bedsleep_910f2c5b:
    ...
    wf "نحن نقدر خصوصيتك، هذه الغرفة وكل ما فيها وأي طرد قد يأتيك في المستقبل خارج حدود أي شخص في المنزل"
...
translate arabic bedsleep_e5a9a46e:
    ...
    wf "قد أكون عجوزاً، ولكن أسلوبي مع الفتيات ما زال بنفس قوته عندما كنت في الثانية عشر."

# game/bedsleep.rpy:89
translate arabic bedsleep_26d11aad:

    # wf "I do buy gifts from time to time."
    wf "كما أني أشتري الهدايا من حين إلى آخر.."
...
translate arabic bedsleep_bd2c8a88:
    ...
    wf "أها، أعتذر منك إذاً، يبدو أنك كنت تمدحني."
